...
```kotlin
implementation("com.configdirector:configdirector-android-compose:1.4.0")  // the Compose sample
implementation("com.configdirector:configdirector-android:1.4.0")          // the Java sample
```
