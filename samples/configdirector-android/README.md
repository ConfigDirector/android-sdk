...
```kotlin
implementation("com.configdirector:configdirector-android-compose:1.5.0")  // the Compose sample
implementation("com.configdirector:configdirector-android:1.5.0")          // the Java sample
```
